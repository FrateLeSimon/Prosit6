...
{
	return "INSERT INTO [DB_P6].[dbo].[TB_P6] (nom, prenom) VALUES('" + this->nom + "','" + this->prenom + "');";
}
...
{
	return "UPDATE [DB_P6].[dbo].[TB_P6] SET nom = '" + this->nom + "', prenom = '" + this->prenom + "' WHERE id = '" + System::Convert::ToString(this->Id) + "';";
}
